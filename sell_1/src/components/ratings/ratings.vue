          ...
          <li v-for="rating in ratings" v-show="needShow(rating.rateType,rating.text)" class="rating-item">
            ...
            <div class="content">
              ...
              <div class="star-wrapper">
                ...
                <span class="delivery" v-show="rating.deliveryTimg">{{rating.deliveryTime}}</span>
              </div>
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    //从Vue的生命周期来说，执行到created的时候是不能保证dom是否被渲染了，bscroll需要确认dom渲染完了
    created(){
      //拿到ratings
